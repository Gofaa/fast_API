...
async def welcome(Authorize: AuthJWT = Depends()):
    ...
    return {
        'message': " Bu auth url signup sahifasi"
    }


@auth_urls.post('/signup', status_code=status.HTTP_201_CREATED)
...
@auth_urls.post('/login', status_code=status.HTTP_200_OK)
